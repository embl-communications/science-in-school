<article class="vf-card vf-card--brand vf-card--striped">
    <img src="https://www.scienceinschool.org/sites/default/files/issueCover/Cover_small4.png"
         alt="Image alt text" class="vf-card__image" loading="lazy">
    <div class="vf-card__content | vf-stack vf-stack--400">
        <h3 class="vf-card__heading"><a class="vf-card__link" href="/issues/52/">Issue 52
