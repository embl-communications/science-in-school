<?php
/*
Plugin Name: VF-SiS Gutenberg
Description: Adds Visual Framework SiS support and blocks to the Gutenberg editor.
Version: 1.0.0-beta.1
Author: EMBL Digital Comms
Plugin URI: https://github.com/embl-communications/science-in-school/
Text Domain: vfwpsis
*/
/**
...
class VF_Gutenberg {
  ...
  /**
   * Render VF Nunjucks template blocks
   */
