				...
				<tr>
					...
					<div id="media_import_box">
						...
						<input id="file_public_path" name="file_public_path" type="text" size="30" value="<?php echo $data['file_public_path']; ?>" /> <small><?php _e('default is:', 'fg-drupal-to-wp'); ?> sites/default/files</small><br />
						...
						<input id="file_private_path" name="file_private_path" type="text" size="30" value="<?php echo $data['file_private_path']; ?>" /> <small><?php _e('default is:', 'fg-drupal-to-wp'); ?> sites/default/private/files</small><br />
