...
if ( !class_exists('FG_Drupal_to_WordPress_DebugInfo', false) ) {
	class FG_Drupal_to_WordPress_DebugInfo {
		...
		public function display() {
			...
			echo  '  max_allowed_packet: '. $this->bytes_format($wpdb->get_var("SHOW VARIABLES LIKE 'max_allowed_packet';", 1)) . "\n";
			echo  '  wait_timeout: '. $wpdb->get_var("SHOW VARIABLES LIKE 'wait_timeout';", 1) . "\n";
