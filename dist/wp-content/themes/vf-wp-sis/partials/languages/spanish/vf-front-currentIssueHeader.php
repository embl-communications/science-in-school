<!-- <style>
    ...
    <article class="vf-box vf-box--is-link vf-box-theme--primary vf-box--normal">
        <h3 class="vf-box__heading"><a class="vf-box__link" href="/issue">¿Has visto...
        </a></h3>
        <p class="vf-box__text">
        Artículos en español de números anteriores

        </p>
        <p class="vf-box__text">
            <a class="vf-link" href="/issue">Ver todos los temas</a>
        </p>
    </article>
