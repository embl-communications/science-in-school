...
<section class="vf-grid vf-grid__col-3">
    <article class="vf-card vf-card--striped sis-article-understand">
        ...
        <div class="vf-card__content | vf-stack vf-stack--400">
            ...
            <p class="vf-card__text">Explorez les sciences de pointe et leurs applications dans le monde réel.
            </p>
        </div>
    </article>
    <article class="vf-card vf-card--striped sis-article-inspire">
        ...
        <div class="vf-card__content | vf-stack vf-stack--400">
            ...
            <!-- <p class="vf-card__subheading">With sub–heading</p> -->
            <p class="vf-card__text">Découvrez des projets, des personnes et des ressources.
            </p>
        </div>
    </article>
    <article class="vf-card vf-card--striped sis-article-teach">
        ...
        <div class="vf-card__content | vf-stack vf-stack--400">
            ...
            <!-- <p class="vf-card__subheading">With sub–heading</p> -->
            <p class="vf-card__text">Trouvez des idées et du matériel pédagogique pour des activités en classe..</p>
        </div>
    </article>
</section>
