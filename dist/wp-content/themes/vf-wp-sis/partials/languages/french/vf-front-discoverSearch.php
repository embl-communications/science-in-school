<form action="/fr/" class="vf-form vf-form--search vf-form--search--responsive | vf-sidebar vf-sidebar--end">
    <div class="vf-sidebar__inner">
        <div class="vf-form__item">
            <label class="vf-form__label vf-u-sr-only | vf-search__label" for="searchitem">Rechercher</label>
            <input type="search" placeholder="Saisissez vos termes de recherche" id="searchitem" name="s" 
        ...
        <button type="submit" class="vf-search__button | vf-button vf-button--primary">
            <span class="vf-button__text">Rechercher</span>
