...
<section class="vf-news-container vf-news-container--featured | embl-grid">
    <div class="vf-section-header"><a class="vf-section-header__heading vf-section-header__heading--is-link"
            href="/eiroforum-events" id="section-sub-heading-link-text">Teaching events <svg aria-hidden="true"
        ...
        <p class="vf-section-header__text">Discover free events and activities offered by the EIROforum members and
            other non-profit groups.</p>
    </div>
    <div class="vf-news-container__content vf-grid vf-grid__col-3">
        ...
        <section class="vf-news-container vf-news-container--featured | embl-grid">
            <div class="vf-section-header"><a class="vf-section-header__heading vf-section-header__heading--is-link"
                ...
                <p class="vf-section-header__text">Discover free events and activities offered by the EIROforum members
                    and other non-profit groups.</p>
            </div>
            <div class="vf-news-container__content vf-grid vf-grid__col-3">
                <?php
